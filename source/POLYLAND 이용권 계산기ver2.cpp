...
int main(){
	...
	do
	{
		...
		*/
		...
		//성인요금 : 만 19세이상 ~ 만64세이하
		if((ticket_type == 1 && ticket_time == 1 && man >= 19) && (ticket_type == 1 && ticket_time == 1) && man <= 64)
		{
			regular_price = ADULT_1DAY_PRICE;
		}
		
		if((ticket_type == 1 && ticket_time == 2 && man >= 19) && (ticket_type == 1 && ticket_time == 2) && man <= 64)
		{
			regular_price = ADULT_A4_PRICE;
		}
		
		if((ticket_type == 2 && ticket_time == 1 && man >= 19) && (ticket_type == 2 && ticket_time == 1) && man <= 64)
		{
			regular_price = ADULT_1DAY_MPRICE;
		}
	
		if((ticket_type == 2 && ticket_time == 2 && man >= 19) && (ticket_type == 2 && ticket_time == 2) && man <= 64)
		{
			regular_price = ADULT_A4_MPRICE;
		}	
	
		//청소년요금 : 만 13세 이상 ~ 만 18세 이하
		if((ticket_type == 1 && ticket_time == 1 && man >= 13) && (ticket_type == 1 && ticket_time == 1 && man <= 18))
		{
			regular_price = YOUTH_1DAY_PRICE;
		}
		
		if((ticket_type == 1 && ticket_time == 2 && man >= 13) && (ticket_type == 1 && ticket_time == 2 && man <= 18))
		{
			regular_price = YOUTH_A4_PRICE;
		}
		
		if((ticket_type == 2 && ticket_time == 1 && man >= 13) && (ticket_type == 2 && ticket_time == 1 && man <= 18))
		{
			regular_price = YOUTH_1DAY_MPRICE;
		}
	
		if((ticket_type == 2 && ticket_time == 2 && man >= 13) && (ticket_type == 2 && ticket_time == 2 && man <= 18))
		{
			regular_price = YOUTH_A4_MPRICE;
		}	
					 		 
		 //어린이요금 : 만 3세 이상 ~ 만 12세 이하
		if((ticket_type == 1 && ticket_time == 1 && man >= 3) && (ticket_type == 1 && ticket_time == 1 && man <= 12))
		{
			regular_price = CHILD_1DAY_PRICE;
		}
		
		if((ticket_type == 1 && ticket_time == 2 && man >= 3) && (ticket_type == 1 && ticket_time == 2 && man <= 12))
		{
			regular_price = CHILD_A4_PRICE;
		}
		
		if((ticket_type == 2 && ticket_time == 1 && man >= 3) && (ticket_type == 2 && ticket_time == 1 && man <= 12))
		{
			regular_price = CHILD_1DAY_MPRICE;
		}
	
		if((ticket_type == 2 && ticket_time == 2 && man >= 3) && (ticket_type == 2 && ticket_time == 2 && man <= 12))
		{
			regular_price = CHILD_A4_MPRICE;
		}	 		 
		 
		 //아기 요금 : 만 1세 이상 ~ 만2세 이하	 
		if((ticket_type == 1 && ticket_time == 1 && man >= 1) && (ticket_type == 1 && ticket_time == 1 && man <= 2))
		{
			regular_price = BABY_1DAY_PRICE;
		}
		
		if((ticket_type == 1 && ticket_time == 2 && man >= 1) && (ticket_type == 1 && ticket_time == 2 && man <= 2))
		{
			regular_price = BABY_A4_PRICE;
		}
		
		if((ticket_type == 2 && ticket_time == 1 && man >= 1) && (ticket_type == 2 && ticket_time == 1 && man <= 2))
		{
			regular_price = BABY_1DAY_MPRICE;
		}
	
		if((ticket_type == 2 && ticket_time == 2 && man >= 1) && (ticket_type == 2 && ticket_time == 2 && man <= 2))
		{
